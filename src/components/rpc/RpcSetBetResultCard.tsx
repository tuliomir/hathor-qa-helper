    ...
    <>
      ...
      <div className="card-primary mb-7.5">
        ...
        <div className="space-y-4">
          ...
          {/* Oracle Signature */}
          <div>
            <label className="block text-sm font-medium mb-1.5">Oracle Signature</label>
            <textarea
              value={oracleSignature}
              onChange={(e) => setOracleSignature(e.target.value)}
              placeholder="Enter oracle signature (will be calculated automatically in future)"
              className="input font-mono text-xs"
              rows={3}
            />
            <p className="text-xs text-muted mt-1">
              The oracle signature to authorize setting the result. This will be calculated automatically in a future update.
            </p>
          </div>
