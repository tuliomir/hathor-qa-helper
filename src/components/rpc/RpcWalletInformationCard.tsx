/**
 * RPC Wallet Information Card Component
 *
 * Card for testing htr_getWalletInformation RPC call
 */
...
export const RpcWalletInformationCard: React.FC<RpcWalletInformationCardProps> = ({
  onExecute,
  disabled = false,
  isDryRun = false,
  initialRequest = null,
  ...
  const handleExecute = async () => {
    ...
    try {
      ...
      console.log(`[RPC Request] Wallet Information`, request);
      console.log(`[RPC Success] Wallet Information`, response);
          ...
          <div>
            ...
            <p className="text-sm text-muted mt-1">
              {isDryRun
                ...
                : 'Send htr_getWalletInformation request to RPC server'}
            </p>
          </div>
