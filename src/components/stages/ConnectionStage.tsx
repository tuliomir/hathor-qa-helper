...
export const ConnectionStage: React.FC = () => {
  ...
  return (
    <div className="max-w-300 mx-auto">
      ...
      <p className="text-muted mb-7.5">Connect to your wallet via WalletConnect and configure RPC testing options</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-800 mt-1 mb-0">
                The wallet being called is not the test wallet. This is not a workflow expected by this helper. Please
                connect the same wallet that was selected as the test wallet.
              </p>
            </div>
          </div>
        </div>
