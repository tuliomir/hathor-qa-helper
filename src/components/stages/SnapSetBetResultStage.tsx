...
export const SnapSetBetResultStage: React.FC = () => {
  const { isSnapConnected, isDryRun, methodData, execute } =
    useSnapMethod('snapSetBetResult');
  ...
  return (
    <div className="max-w-300 mx-auto">
      ...
      <p className="text-muted mb-7.5">
        Set the result of a Bet nano contract via MetaMask Snap
      </p>
      ...
      {isSnapConnected && (
        ...
        >
          ...
          <div>
            ...
            <input type="text" value={result} onChange={(e) => setResult(e.target.value)} placeholder="e.g. heads" className="input" />
          </div>
          <div>
