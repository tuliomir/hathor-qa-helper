...
export const SnapFeeDepositStage: React.FC = () => {
  ...
  const params = useMemo(() => {
    ...
    if (contractPaysFees && htrWithdrawAmount) {
      actions.push({ type: 'withdrawal', token: '00', amount: htrWithdrawAmount, address: changeAddress, changeAddress });
    }
  ...
  return (
    <div className="max-w-300 mx-auto">
      ...
      <p className="text-muted mb-7.5">
        Deposit a fee-based token into a Fee nano contract via MetaMask Snap
      </p>
      ...
      {isSnapConnected && (
        ...
        >
          ...
          <div>
            ...
            <input type="text" value={amount} onChange={(e) => setAmount(e.target.value)} placeholder="Amount to deposit" className="input" />
          </div>
          <div>
