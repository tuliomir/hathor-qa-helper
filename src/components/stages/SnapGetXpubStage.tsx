        ...
        <>
          <div className="bg-yellow-50 border border-yellow-300 rounded p-4 mb-5 space-y-2">
            <p className="text-sm text-yellow-800 m-0">
              <strong>Origin restricted:</strong> The snap only allows <code>htr_getXpub</code> from
              whitelisted origins. If you get an &quot;not authorized for origin&quot; error, add your
              origin to the snap&apos;s <code>RPC_RESTRICTIONS</code>.
            </p>
            <p className="text-xs text-yellow-700 m-0">
              In <code>hathor-rpc-lib/packages/snap/src/constants.ts</code>, add{' '}
              <code>&apos;http://localhost:5173&apos;</code> to the{' '}
              <code>RPC_RESTRICTIONS[GetXpub]</code> array, then rebuild the snap.
            </p>
          </div>
          <SnapMethodCard
            title="Get Xpub"
