  ...
  steps: [
    {
      ...
      instructions:
        'Register the **HIDET** token using the configuration string below.' +
    ...
    },
    {
      ...
      instructions:
        'Click the link in the About tab to disable the always-show setting.' +
