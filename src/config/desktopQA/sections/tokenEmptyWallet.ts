  ...
  steps: [
    {
      ...
      instructions:
        'Navigate to **Custom tokens** section and select **Create new token**.' +
    ...
    },
    {
      ...
      instructions: 'Attempt to create the token and confirm that an **error for insufficient HTR** is displayed.',
    },
  ],
};
